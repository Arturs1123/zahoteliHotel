...
export default function HotelItem({
    ...
    return (
        <div className={`rounded-xl border ${props.className ? props.className : ''}`}>
            <div className="p-[4px] relative middle:w-full">
                <Carousel
                    customRightArrow={
                ...
                >
                    {thumbnails.map((thumbnail, i) => (
                        <img key={i} src={thumbnail} className="middle:h-full h-[200px] w-full" title="thumbnail" alt="thumbnail" style={{ objectFit: 'cover' }} />
                    ))}
                </Carousel>
            ...
            <div className="p-[16px] middle:grow">
                    ...
                    <div className="grow">
                        <div className="flex md:justify-start justify-between">
                            ...
                            <div className="md:hidden block">
                                <RatingBadge size="sm" rating={rating} />
                            </div>
                        </div>
                        <p className="font-medium text-xl mb-2">{hotelName}</p>
                    </div>
                    <div className="md:block hidden">
                        <RatingBadge size="md" rating={rating} />
                    </div>
                </div>
                ...
                <div className="flex items-center mb-[32px] md:hidden block">
