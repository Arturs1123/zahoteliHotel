...
import { getAccessibleEnvironments, getAmentities, getBeautyAndHealth, getConferenceFacilities, getHotelStaffSays, getSeaAndBeachAllOptions } from "@/app/backend_apis";
